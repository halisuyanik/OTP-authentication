            ...
            <div className="py-6 lg:py-0 w-full md:w-8/12 lg:w-6/12 xl:w-4/12 relative">
              ...
              <div className="mb-8 text-center">
                ...
                <p className="text-gray-500">
                  Welcome, enter recovery password
                </p>
              </div>
              {/* END Header */}
                  ...
                  <div className="sm:p-5 lg:px-10 lg:py-8">
                    <form className="space-y-6" >
                      <div className="space-y-1">
                        <label htmlFor="password" name="password" className="font-medium">Email</label>
                        <input  className="block border
                         border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-teal-500 focus:ring
                          focus:ring-teal-500 focus:ring-opacity-50" type="email" id="password" name="email" placeholder="Enter your email" />  
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2 sm:flex sm:items-center sm:justify-between sm:space-x-2 sm:space-y-0 mt-4">
                          <label className="flex items-center">
                            <span className="ml-2">
                              can't get password? <button className='text-red-500'>Resend</button>
                            </span>
                          </label>
                        </div>
                      </div>
