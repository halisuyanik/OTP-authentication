...
import { resetPasswordValidate } from "../utilities/validate";
                ...
                <div className="p-5 lg:p-6 grow w-full">
                  <div className="sm:p-5 lg:px-10 lg:py-8">
                    <form className="space-y-6" onSubmit={formik.handleSubmit}>
                      ...
                      <div className="space-y-1">
                      <label htmlFor="confirm_pass" name="confirm_pass" className="font-medium">Confirm password</label>
                        <input {...formik.getFieldProps('confirm_pass')} className="block border
                         border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-teal-500 focus:ring
                          focus:ring-teal-500 focus:ring-opacity-50" type="password" id="confirm_pass" name="confirm_pass" placeholder="Re-enter your password" /> 
                      </div>
